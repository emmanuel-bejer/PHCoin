...
class _AllChartState extends State<AllChart> {
  ...
  List<BarChartGroupData> showingGroups() => List.generate(3, (i) {
        switch (i) {
          case 0:
            return makeGroupData(0, 2.5);
          case 1:
            return makeGroupData(1, 1.8);
          case 2:
            return makeGroupData(2, 2.0);
          //  No Need to include case 3-7 since there are only 3 Coins at the moment
          // case 3:
  ...
  Widget getTiles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 0:
        text = const Text("GC", style: style);
        break;
      case 1:
        text = const Text("BC", style: style);
        break;
      case 2:
